...
import { create, update, remove } from './pagamentoActions'

import List from './pagamentoList'
import Form from './pagamentoForm'
...
export default connect(null, mapDispatchToProps)(Pagamento)