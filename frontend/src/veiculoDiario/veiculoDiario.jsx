...
import { create, update, remove } from './veiculoDiarioActions'

import List from './veiculoDiarioList'
import Form from './veiculoDiarioForm'

class VeiculoDiario extends Component {
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Veiculos Diarios' small='Cadastro' />
                <Content>
                    <Tabs>
                        <TabsHeader>
...
export default connect(null, mapDispatchToProps)(VeiculoDiario)