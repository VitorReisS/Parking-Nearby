...
import { init } from './veiculoDiarioActions'
import LabelAndInput from '../common/form/labelAndInput'

class VeiculoDiarioForm extends Component {
        ...
        return (
            <form role='form' onSubmit={handleSubmit}>
                <div className='box-body'>
                    ...
                    <Field name='tipo_veiculo' component={LabelAndInput} readOnly={readOnly} label='Tipo de Veículo' cols='12 4' placeholder='Informe o tipo de veículo' />
...
VeiculoDiarioForm = reduxForm({ form: 'veiculoDiarioForm', destroyOnUnmount: false })(VeiculoDiarioForm)
const mapDispatchToProps = dispatch => bindActionCreators({ init }, dispatch)
export default connect(null, mapDispatchToProps)(VeiculoDiarioForm)